...
type BannerRotatorServiceClient interface {
	AddBannerToSlot(ctx context.Context, in *BannerAndSlotRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	RemoveBannerFromSlot(ctx context.Context, in *BannerAndSlotRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	AddClick(ctx context.Context, in *AddClickRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *bannerRotatorServiceClient) AddBannerToSlot(ctx context.Context, in *BannerAndSlotRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *bannerRotatorServiceClient) RemoveBannerFromSlot(ctx context.Context, in *BannerAndSlotRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *bannerRotatorServiceClient) AddClick(ctx context.Context, in *AddClickRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type BannerRotatorServiceServer interface {
	AddBannerToSlot(context.Context, *BannerAndSlotRequest) (*emptypb.Empty, error)
	RemoveBannerFromSlot(context.Context, *BannerAndSlotRequest) (*emptypb.Empty, error)
	AddClick(context.Context, *AddClickRequest) (*emptypb.Empty, error)
...
func (UnimplementedBannerRotatorServiceServer) AddBannerToSlot(context.Context, *BannerAndSlotRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddBannerToSlot not implemented")
}
func (UnimplementedBannerRotatorServiceServer) RemoveBannerFromSlot(context.Context, *BannerAndSlotRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveBannerFromSlot not implemented")
}
func (UnimplementedBannerRotatorServiceServer) AddClick(context.Context, *AddClickRequest) (*emptypb.Empty, error) {
